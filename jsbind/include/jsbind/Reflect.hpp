...
class Reflect : public emlite::Val {
  public:
    ...
    static bool defineProperty(const Any &target, const Any &key, const Any &attributes);
    ...
    static bool deleteProperty(const Any &target, const Any &key);
    ...
    static Any get(const Any &target, const Any &key, const Any &receiver = Any());
    ...
    static Any getOwnPropertyDescriptor(const Any &target, const Any &key);
    ...
    static bool setPrototypeOf(const Any &target, const Any &proto);
};
} // namespace jsbind
