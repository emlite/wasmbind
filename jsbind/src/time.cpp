...
void clear_timeout(int32_t id) { emlite::Val::global("clearTimeout")(emlite::Val(id)); }

void clear_interval(int32_t id) { emlite::Val::global("clearInterval")(emlite::Val(id)); }
