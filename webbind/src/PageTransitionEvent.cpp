...
PageTransitionEvent::PageTransitionEvent(const jsbind::String& type, const jsbind::Any& eventInitDict) : Event(emlite::Val::global("PageTransitionEvent").new_(type, eventInitDict)) {}
