...
jsbind::Promise<jsbind::Undefined> PeriodicSyncManager::register_(const jsbind::DOMString& tag) {
    return emlite::Val::call("register", tag).as<jsbind::Promise<jsbind::Undefined>>();
}

jsbind::Promise<jsbind::Undefined> PeriodicSyncManager::register_(const jsbind::DOMString& tag, const BackgroundSyncOptions& options) {
    return emlite::Val::call("register", tag, options).as<jsbind::Promise<jsbind::Undefined>>();
}

jsbind::Promise<jsbind::Sequence<jsbind::DOMString>> PeriodicSyncManager::getTags() {
    return emlite::Val::call("getTags").as<jsbind::Promise<jsbind::Sequence<jsbind::DOMString>>>();
}

jsbind::Promise<jsbind::Undefined> PeriodicSyncManager::unregister(const jsbind::DOMString& tag) {
