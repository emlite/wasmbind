...
BufferedChangeEvent::BufferedChangeEvent(const jsbind::String& type, const jsbind::Any& eventInitDict) : Event(emlite::Val::global("BufferedChangeEvent").new_(type, eventInitDict)) {}
