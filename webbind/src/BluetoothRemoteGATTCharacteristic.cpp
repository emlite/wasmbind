...
jsbind::Promise BluetoothRemoteGATTCharacteristic::getDescriptor(const jsbind::Any& descriptor) {
...
jsbind::Promise BluetoothRemoteGATTCharacteristic::readValue() {
    return EventTarget::call("readValue").as<jsbind::Promise>();
}

jsbind::Promise BluetoothRemoteGATTCharacteristic::writeValue(const jsbind::Any& value) {
    return EventTarget::call("writeValue", value).as<jsbind::Promise>();
}

jsbind::Promise BluetoothRemoteGATTCharacteristic::writeValueWithResponse(const jsbind::Any& value) {
    return EventTarget::call("writeValueWithResponse", value).as<jsbind::Promise>();
}

jsbind::Promise BluetoothRemoteGATTCharacteristic::writeValueWithoutResponse(const jsbind::Any& value) {
    return EventTarget::call("writeValueWithoutResponse", value).as<jsbind::Promise>();
}

jsbind::Promise BluetoothRemoteGATTCharacteristic::startNotifications() {
    return EventTarget::call("startNotifications").as<jsbind::Promise>();
}

jsbind::Promise BluetoothRemoteGATTCharacteristic::stopNotifications() {
    return EventTarget::call("stopNotifications").as<jsbind::Promise>();
}
