...
OfflineAudioCompletionEvent::OfflineAudioCompletionEvent(const jsbind::String& type, const jsbind::Any& eventInitDict) : Event(emlite::Val::global("OfflineAudioCompletionEvent").new_(type, eventInitDict)) {}
