...
IdentityCredentialError::IdentityCredentialError(const jsbind::String& message, const IdentityCredentialErrorInit& options) : DOMException(emlite::Val::global("IdentityCredentialError").new_(message, options)) {}
