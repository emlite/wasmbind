...
MediaKeyMessageEvent::MediaKeyMessageEvent(const jsbind::DOMString& type, const jsbind::Any& eventInitDict) : Event(emlite::Val::global("MediaKeyMessageEvent").new_(type, eventInitDict)) {}
