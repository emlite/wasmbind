...
jsbind::Promise ImageCapture::getPhotoCapabilities() {
    return emlite::Val::call("getPhotoCapabilities").as<jsbind::Promise>();
}

jsbind::Promise ImageCapture::getPhotoSettings() {
    return emlite::Val::call("getPhotoSettings").as<jsbind::Promise>();
}

jsbind::Promise ImageCapture::grabFrame() {
    return emlite::Val::call("grabFrame").as<jsbind::Promise>();
}
