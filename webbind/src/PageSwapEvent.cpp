...
PageSwapEvent::PageSwapEvent(const jsbind::DOMString& type) : Event(emlite::Val::global("PageSwapEvent").new_(type)) {}

PageSwapEvent::PageSwapEvent(const jsbind::DOMString& type, const jsbind::Any& eventInitDict) : Event(emlite::Val::global("PageSwapEvent").new_(type, eventInitDict)) {}
