...
public:
    ...
    jsbind::Promise<jsbind::DOMString> directFromSellerSignalsHeaderAdSlot() const;
    void directFromSellerSignalsHeaderAdSlot(const jsbind::Promise<jsbind::DOMString>& value);
    jsbind::Promise<jsbind::Record<jsbind::USVString, jsbind::USVString>> deprecatedRenderURLReplacements() const;
    void deprecatedRenderURLReplacements(const jsbind::Promise<jsbind::Record<jsbind::USVString, jsbind::USVString>>& value);
    ...
    jsbind::Promise<jsbind::Record<jsbind::USVString, jsbind::Any>> perBuyerSignals() const;
    void perBuyerSignals(const jsbind::Promise<jsbind::Record<jsbind::USVString, jsbind::Any>>& value);
    jsbind::Promise<jsbind::Record<jsbind::USVString, long long>> perBuyerTimeouts() const;
    void perBuyerTimeouts(jsbind::Promise<jsbind::Record<jsbind::USVString, long long>> value);
    jsbind::Promise<jsbind::Record<jsbind::USVString, long long>> perBuyerCumulativeTimeouts() const;
    void perBuyerCumulativeTimeouts(jsbind::Promise<jsbind::Record<jsbind::USVString, long long>> value);
    ...
    jsbind::Promise<jsbind::Record<jsbind::USVString, jsbind::USVString>> perBuyerCurrencies() const;
    void perBuyerCurrencies(const jsbind::Promise<jsbind::Record<jsbind::USVString, jsbind::USVString>>& value);
...
public:
    ...
    jsbind::Promise<MediaKeySystemAccess> requestMediaKeySystemAccess(const jsbind::DOMString& keySystem, const jsbind::Sequence<MediaKeySystemConfiguration>& supportedConfigurations);
    jsbind::Promise<jsbind::Undefined> deprecatedReplaceInURN(const jsbind::Any& urnOrConfig, const jsbind::Record<jsbind::USVString, jsbind::USVString>& replacements);
    jsbind::Promise<jsbind::USVString> deprecatedURNtoURL(const jsbind::Any& urnOrConfig);
    jsbind::Promise<jsbind::USVString> deprecatedURNtoURL(const jsbind::Any& urnOrConfig, bool send_reports);
    ...
    jsbind::Promise<jsbind::Sequence<RelatedApplication>> getInstalledRelatedApps();
    ...
    jsbind::Promise<jsbind::Undefined> clearOriginJoinedAdInterestGroups(const jsbind::USVString& owner);
    jsbind::Promise<jsbind::Undefined> clearOriginJoinedAdInterestGroups(const jsbind::USVString& owner, const jsbind::Sequence<jsbind::USVString>& interestGroupsToKeep);
    ...
    jsbind::Promise<jsbind::DOMString> createAuctionNonce();
