...
public:
    ...
    OffscreenCanvasRenderingContext2D clone() const noexcept;
    OffscreenCanvas canvas() const;
    ...
    jsbind::String letterSpacing() const;
    ...
    jsbind::String wordSpacing() const;
