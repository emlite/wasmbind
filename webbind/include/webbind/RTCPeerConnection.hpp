...
public:
    ...
    jsbind::Promise setRemoteDescription(const RTCSessionDescriptionInit& description, const jsbind::Any& successCallback, const jsbind::Function& failureCallback);
    ...
    jsbind::Promise addIceCandidate(const RTCIceCandidateInit& candidate, const jsbind::Any& successCallback, const jsbind::Function& failureCallback);
    ...
    static jsbind::Promise generateCertificate(const jsbind::Any& keygenAlgorithm);
